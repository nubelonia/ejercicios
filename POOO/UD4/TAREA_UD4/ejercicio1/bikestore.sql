...
-- Tiempo de generación: 05-03-2024 a las 19:09:16
...
CREATE TABLE `orders` (
  ...
  `shipped_date` text DEFAULT NULL,
...
ALTER TABLE `orders`
  ...
  ADD KEY `fk_store_3_idx` (`store_id`),
  ADD KEY `fk_staff_2_idx` (`staff_id`);
...
ALTER TABLE `order_items`
  ...
  ADD KEY `fk_prodcuto_4_idx` (`product_id`);
...
ALTER TABLE `staffs`
  ...
  ADD KEY `fk_store_2_idx` (`store_id`),
  ADD KEY `fk_manager_idx` (`manager_id`);
...
ALTER TABLE `stocks`
  ...
  ADD KEY `fk_producto_2_idx` (`product_id`);
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `fk_staff_2` FOREIGN KEY (`staff_id`) REFERENCES `staffs` (`staff_id`),
  ADD CONSTRAINT `fk_store_3` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`);
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `fk_prodcuto_4` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
...
--
-- Filtros para la tabla `staffs`
--
ALTER TABLE `staffs`
  ADD CONSTRAINT `fk_manager` FOREIGN KEY (`manager_id`) REFERENCES `staffs` (`staff_id`),
  ADD CONSTRAINT `fk_store_2` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`);

--
-- Filtros para la tabla `stocks`
--
ALTER TABLE `stocks`
  ADD CONSTRAINT `fk_producto_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`),
